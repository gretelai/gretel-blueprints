Imbalanced datasets are a common problem in machine learning. For example, if the training data has imbalanced demographic, AI models can exhibit representational biases.
